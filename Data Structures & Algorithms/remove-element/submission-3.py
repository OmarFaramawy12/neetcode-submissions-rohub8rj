class Solution:
    ...
    II- More effiecient Solution is provided in Solution-4
    Main Idea of optimal Solution: 1- Decrease the number of copies this will be achived by
                                   2- making a copy from the end of the array with an element != val
